...
const Chairman = () => {
  return (
    <div className="box relative lg:py-8 pb-8  grid lg:grid-cols-2 bg-[#DEDEDE] my-4">
      <div className="w-full px-4 relative flex items-center justify-center flex-col py-32">
        ...
        <div className=" flex flex-col gap-8 lg:p-4 pt-20 lg:absolute lg:left-1/2 lg:-translate-x-1/2 lg:top-16">
          <div className="h-[350px] w-[250px] border-8 border-white rounded relative">
        ...
        <div className="grid lg:grid-cols-2 gap-8 pt-8">
          <div className="flex gap-4 items-start">
            ...
            <p className="flex-1">
              ...
              services, warehouse management, international freight forwarding,
              express distribution services, 3pl/4pl, packaging and project
              management.
            </p>
          </div>
          ...
          <div className="flex gap-4 items-start">
            <div className="w-3 h-3 bg-black mt-2"></div>
            <p className="flex-1">
              As the preferred supplier for fortune 100 automobile companies and
              the first point of contact to increase the efficiency in India, we
              are proud of our reputation and will always strive to maintain it.
              With over 18 years of experience in the market and dealing with
              different verticals and projects, our constant commitment and
              value delivery has enabled us to earn the trust of our clients.
            </p>
          </div>
          ...
          <div className="flex gap-4 items-start">
            <div className="w-3 h-3 bg-black mt-2"></div>
            <p className="flex-1">
              We are enterprising, and we see ourselves at a different level in
              the next couple of years with regards to new products and
          ...
          <div className="flex gap-4 items-start">
            <div className="w-3 h-3 bg-black mt-2"></div>
            <p className="flex-1">
              The inception of Vinsum Axpress was in year 2002. It emerged as a
              fast growing freight forwarding company, spreading its wings PAN
              INDIA to reach out and extend valuable support to its valued
